 ...
 */
//if ( class_exists( 'OT_Loader_child' ) && defined( 'OT_PLUGIN_MODE' ) && OT_PLUGIN_MODE == true ) {
//  
...
//    
//}
//register_activation_hook( __FILE__, 'extension_plugin_activate' );
...
//      if ( OT_PLUGIN_MODE ) {
//      
//        load_plugin_textdomain( 'option-tree-child', false, OT_LANG_DIR );
//        
//      } else {
//      
//        load_theme_textdomain( 'option-tree-child', OT_LANG_DIR );
//        
//      }
//      
//    }
